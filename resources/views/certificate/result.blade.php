...
@section('description', 'Certificate verification result showing the authenticity and details of the verified certificate.')
...
<section class="relative py-12 bg-gradient-to-b from-light to-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gradient-to-r {{ $certificate->is_verified ? 'from-green-500 to-green-600' : 'from-red-500 to-red-600' }} px-6 py-8 text-center">
            ...
            <div class="p-8">
                ...
                <div class="mt-8 text-center space-y-4">
                    ...
                    <div class="text-sm text-gray-600">
                        <p>Need help? Contact us at <a href="mailto:support@school.com" class="text-primary hover:text-primary/80">support@school.com</a></p>
                    </div>
                </div>
            </div>
        </div>
