...
@section('description', 'Verify the authenticity of graduation certificates issued by Varin Academy. Enter certificate ID or scan QR code to check verification status.')
